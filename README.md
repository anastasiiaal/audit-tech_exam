# TaskWatch - Projet d'Évaluation M2 Développeur Fullstack

![TaskWatch](https://img.shields.io/badge/Status-Prêt%20pour%20Audit-orange)
...
- [Méthodologie Conseillée](#méthodologie-conseillée)
...
**TaskWatch** est une application de suivi de tâches et de temps pour une équipe. Elle permet aux utilisateurs de créer, organiser et suivre leurs tâches, ainsi que d'enregistrer le temps passé sur chacune d'elles.
...
- **Gérer des tâches**
  ...
  - Modifier le statut (À faire, En cours, Terminée)
  - Filtrer par statut
  - Rechercher par nom

- **Suivre le temps**

  - Démarrer/Arrêter un timer sur une tâche
  - Voir le temps total passé sur chaque tâche

- **Visualiser les statistiques**
  - Dashboard avec nombre de tâches par statut
...
cd assessment-audit-diagnostic
...
# 4. Seed de la base de données (créer plusieurs milliers de tâches)
...
│   └── seed.sql             # Alternative SQL pour le seed
│
...
Réalisez un **audit complet de performance et de qualité de code** en suivant une méthodologie en 4 phases : **(1) Identification des flux** (cartographie de l'architecture et des parcours utilisateurs), **(2) Instrumentation** (collecte de métriques via Lighthouse, DevTools, EXPLAIN ANALYZE), **(3) Analyse** (diagnostic des causes racines et priorisation par impact), **(4) Optimisation** (corrections itératives avec mesures avant/après).
...
2. **Push sur votre repository**
   ...
   ```bash
   git add .
   git commit -m "Final: Audit et optimisations TaskWatch"
